...
@dataclass
class TranslationWithActorCriticPostEditConfig(TranslationWithActorCriticConfig):
    mt_data: str = field(default="")
    pe_data: str = field(default="")
    use_pe_for_eval: bool = field(default=False)

@register_task("translation_with_actor_critic_post_edit", dataclass=TranslationWithActorCriticPostEditConfig)
class TranslationWithActorCriticPostEdit(TranslationWithActorCritic):
